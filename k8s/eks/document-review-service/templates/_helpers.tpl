...
{{- define "document-review-service.selectorLabels" -}}
app.kubernetes.io/name: {{ include "document-review-service.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "document-review-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- default (include "document-review-service.fullname" .) .Values.serviceAccount.name -}}
{{- else -}}
{{- default "default" .Values.serviceAccount.name -}}
{{- end -}}
{{- end -}}

{{- define "document-review-service.podAnnotations" -}}
